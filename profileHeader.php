...
<html>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav custom-navbar pl-3">
            <li class="nav-item">
                <img src="'.$std_img.'" alt="studentImage" class="stdProfileImg">
            </li>
            <li class="nav-item custom-nav-item mr-2">
            ...
            <li class="nav-item custom-nav-item mr-2">
                <a class="nav-link" href="stdfeedback.php">
                    <i class="fas fa-comments"></i> Feedback
                </a>
            </li>
            <li class="nav-item custom-nav-item mr-2">
                <a class="nav-link" href="changeStdPass.php">
