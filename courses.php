...
<body style="background-color: #f3e0dc;">
	...
	<div class="container mt-5 container-cat" style="padding-top:0px; padding-bottom: 40px;">
		<h1 class="text-center mb-5"><?php echo $category_name; ?></h1>
		...
		<div class="card-deck">
			...
			if ($result->num_rows > 0) {
				while ($row = $result->fetch_assoc()) {
					...
					<div class="card">
						<img src="' . $course_img . '" class="card-img-top" alt="image" style="width: 100%; height: 170px;">
						<div class="card-body">
							<h5 class="card-title">' . $course_name . '</h5>
						</div>
						<div class="card-footer d-flex align-items-center justify-content-between">
							<p class="card-text d-inline mr-2">Price: <small><del>Rs. ' . $course_original_price . ' </del></small> <span class="font-weight-bolder">Rs. ' . $course_price . '</span></p>
							<a href="course_details.php?course_id=' . $course_id . '" class="btn view view-2">View Course</a>
						</div>
					</div>
					</a>';
				}
